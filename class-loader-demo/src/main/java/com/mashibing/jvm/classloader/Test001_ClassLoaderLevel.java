 ...
 */
public class Test001_ClassLoaderLevel {
	public static void main(String[] args) {
		...
		System.out.println(Test001_ClassLoaderLevel.class.getClassLoader());

		//类加载器的加载器
		System.out.println(sun.net.spi.nameservice.dns.DNSNameService.class.getClassLoader().getClass().getClassLoader());
		System.out.println(Test001_ClassLoaderLevel.class.getClassLoader().getClass().getClassLoader());
